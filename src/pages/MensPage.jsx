  ...
  return (
    ...
    <div className="font-sans min-h-screen flex flex-col justify-between bg-white overflow-hidden">
      ...
      <main
        ...
        style={{ backgroundImage: "url('/assets/mens_cover_img.png')" }}
      >
        <div
          ref={mainTextRef}
        ...
        >
          {/* Buttons */}
          <div className="absolute top-0 left-0 px-16 py-10 space-x-8 space-y-4">
            <button className="text-white text-4xl font-bold whitespace-nowrap">
              MENS
            </button>
            <button
              className="text-gray-300 text-lg hover:text-white whitespace-nowrap"
...
<div className="grid grid-cols-3 grid-rows-4 w-full min-h-screen h-auto">
        {/* Row1 */}
        <div 
        ...
        <div 
          ...
          style={{ 
            backgroundImage: "url('/assets/coats.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
        ...
        <div 
          ...
          style={{ 
            backgroundImage: "url('/assets/jackets.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
        ...
        <div 
          ...
          className="relative overflow-hidden transition-all duration-300 group cursor-pointer" 
          style={{ 
            backgroundImage: "url('/assets/pants.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
        ...
        <div 
          ...
          className="relative overflow-hidden transition-all duration-300 group cursor-pointer" 
          style={{ 
            backgroundImage: "url('/assets/sweaters.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
        ...
        {/* Row3 */}
        <div 
          ref={el => categoriesRef.current[5] = el}
          className="relative overflow-hidden transition-all duration-300 group cursor-pointer" 
          style={{ 
            backgroundImage: "url('/assets/hoodies.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
        ...
        <div 
          ref={el => categoriesRef.current[6] = el}
          className="relative overflow-hidden transition-all duration-300 group cursor-pointer" 
          style={{ 
        ...
        <div 
          ref={el => categoriesRef.current[7] = el}
          className="relative overflow-hidden transition-all duration-300 group cursor-pointer" 
          style={{ 
            backgroundImage: "url('/assets/suits.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
        ...
        {/* Row4 */}
        <div 
          ref={el => categoriesRef.current[8] = el}
          className="col-span-2 row-span-1 relative overflow-hidden transition-all duration-300 group cursor-pointer" 
          style={{ 
            backgroundImage: "url('/assets/watches.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
        ...
        <div 
          ref={el => categoriesRef.current[9] = el}
          className="row-span-1 relative overflow-hidden transition-all duration-300 group cursor-pointer" 
          style={{ 
            backgroundImage: "url('/assets/tees.png')", 
            backgroundSize: 'cover', 
            backgroundPosition: 'center',
            width: '100%',
            height: '80vh',
...
<div className={`block md:hidden ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
 ...
 <main className="relative h-screen">
        ...
        >
          <button className="text-white text-4xl font-bold">MENS</button>
          <button
      ...
      <div className="flex flex-col">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/assets/new_arrivals_m_m.png')",
          }}
        >
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/assets/coats_m_m.png')",
          }}
        >
        ...
        <div
          ...
          className="h-[50vh] bg-cover bg-center flex items-center justify-center"
          style={{
            backgroundImage: "url('/assets/jackets_m_m.png')",
          }}
        >
          <h1 className="text-white text-3xl font-bold">Jackets</h1>
        </div>
        ...
        <div
          ...
          className="h-screen bg-cover bg-center flex items-center justify-center"
          style={{
            backgroundImage: "url('/assets/sweater_m_m.png')",
          }}
        >
          <h1 className="text-black text-3xl font-bold ">Sweater & Cartigans</h1>
        </div>
        ...
        >
          <h1 className="text-white text-3xl font-bold">Hoodies</h1>
        </div>
        ...
        <div
          ...
          className="h-[50vh] bg-cover bg-center flex items-center justify-center"
          style={{
            backgroundImage: "url('/assets/shoes_m_m.png')",
          }}
        >
          <h1 className="text-white text-3xl font-bold">Shoes</h1>
        </div>
        ...
        >
          <h1 className="text-white text-3xl font-bold">Suits</h1>
        </div>
        ...
        >
          <h1 className="text-white text-3xl font-bold">Watches & Accesories</h1>
        </div>
        ...
        >
          <h1 className="text-white text-3xl font-bold">Tees & Sweatshirts</h1>
        </div>
